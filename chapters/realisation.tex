...
\paragraph{} Pour cela de trouver comment adapter les contrôles classiques d’un gameplay donné en contrôles naturels, cad, comment passer de la manette à un contrôle par les gestes pour chaque type de gameplay.
