...
\begin{figure}[hbt]
	...
	\caption{Séance de test du jeu Hammer \& Planks au centre hospitaler de Lapeyronie}
...
\label{empathie_elsa}
	...
	\subsubsection*{Imaginer les cas d'utilisation}
La suite de la méthode de conception vient se servir des résultats des premières étapes. Il s'agit d'imaginer les différents cas d'utilisation de l'application. On va chercher à couvrir la totalité des fonctionnalités souhaitées de l'application
